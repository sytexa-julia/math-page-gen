...
/*
 ...
 |  http://sytexa.com
 |  ========================================
 |  Time: Monday, October 23, 2006 4:07:05 PM
 +--------------------------------------------------------
 */ 

#ifndef __MPG_ALGEBRA_PROBLEM_H
#define __MPG_ALGEBRA_PROBLEM_H

#include "mpgMathProblem.h"

class mpgAlgebraProblem : 
...
public:
	mpgAlgebraProblem( void );
	mpgAlgebraProblem( const string &prob, const string &var, const double sltn );
	~mpgAlgebraProblem( void );
	...
	const string *GetTermArray( void );
};
