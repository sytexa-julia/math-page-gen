...
/*
 ...
 |  http://sytexa.com
 |  ========================================
 |  Time: Tuesday, October 17, 2006 8:52:26 PM
 +--------------------------------------------------------
 */ 

#ifndef __WX_UTILITIES_H
#define __WX_UTILITIES_H
...
{
public:
	static wxString string2wxString( std::string &input );
};
