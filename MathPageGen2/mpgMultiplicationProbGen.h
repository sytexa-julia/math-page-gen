...
/*
 +--------------------------------------------------------
 |  Math Page Generator
 |  FILENAME: mpgMultiplicationProbGen.h
 |  VERSION:  2.0.0
 |  ========================================
 ...
 |  http://sytexa.com
 |  ========================================
 |  Time: Saturday, October 21, 2006 6:12:59 PM
 +--------------------------------------------------------
 */

#ifndef __MPG_MULTIPLICATION_PROB_GEN_H
#define __MPG_MULTIPLICATION_PROB_GEN_H
...
class mpgMultiplicationProbGen : 
	public mpgGenerationAlgorithm
{
public:
	mpgMultiplicationProbGen( void );
	mpgMultiplicationProbGen( int prblmCnt, int cmplxty );
